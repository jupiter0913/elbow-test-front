...
import ContractAbi from "assets/abis/Croudfund.json";

export const NFT_ADDRESS = "0x463d55d6416a7CCa1f7C005a6AC8f0dD70a6f410";
export const NETWORK_ID = 1; //4

export const ABC = "abc";
export const RPC_MAIN_NET =
  "https://eth-mainnet.alchemyapi.io/v2/AJQ3xAToNbhrRgr-JKAnZzYYT0-KrC8P";
